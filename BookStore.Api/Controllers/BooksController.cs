...
using BookStore.Api.Applications.BookOperations.Commands.DeleteBook;
using BookStore.Api.Applications.BookOperations.Commands.UpdateBook;
...
namespace BookStore.Api.Controllers
{
    ...
    public class BooksController : ControllerBase
    {
        ...
        public BooksController(IBookStoreDbContext dbContext, IMapper mapper)
        {
